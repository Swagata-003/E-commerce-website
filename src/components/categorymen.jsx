...
const Categorymen=()=>{
  ...
  <div className="col-lg-6">
    <h1 class="display-5 fw-bold text-body-emphasis lh-1 mb-3" style={{fontFamily:'Winky Rough, sans-serif',marginLeft:'-48px'}}>
...
<div className="col-auto">
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="#!">Printed T-shirts</a></li>
    <li><a class="dropdown-item" href="#!">Chikankari Kurta Set</a></li>
    <li><a class="dropdown-item" href="#!">Gym Vests</a></li>
  </ul>
</div>
</div>
<div className="col-auto">
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="#!">Loose Fit Printed T-shirt</a></li>
    <li><a class="dropdown-item" href="#!">Loose Fit Cargo trousers</a></li>
    <li><a class="dropdown-item" href="#!">Oversized Blazers</a></li>
  </ul>
</div>
</div>
</div>
...
<div class="card" style={{width: '18rem',border:'none',marginTop:'25px'}}>
  ...
  <div class="card-body">
    <p class="card-text" style={{fontFamily:'cursive',fontSize:'30px',fontWeight:'bold',marginLeft:'60px'}}>T-shirts</p>
  </div>
</div>
</div>
<div className="col-lg-3 col-md-6 col-sm-12">
...
<div class="card" style={{width: '18rem',border:'none',marginTop:'25px'}}>
  ...
  <div class="card-body">
    <p class="card-text" style={{fontFamily:'cursive',fontSize:'30px',fontWeight:'bold',marginLeft:'60px'}}>Shirts</p>
  </div>
</div>
</div>
<div className="col-lg-3 col-md-6 col-sm-12">
<div class="card" style={{width: '18rem',border:'none',marginTop:'25px'}}>
  ...
  <div class="card-body">
    <p class="card-text" style={{fontFamily:'cursive',fontSize:'30px',fontWeight:'bold',marginLeft:'60px'}}>Kurtas</p>
  </div>
</div>
</div>
<div className="col-lg-3 col-md-6 col-sm-12">
<div class="card" style={{width: '18rem',border:'none',marginTop:'25px'}}>
  ...
  <div class="card-body">
    <p class="card-text" style={{fontFamily:'cursive',fontSize:'30px',fontWeight:'bold',marginLeft:'60px'}}>Kurta Sets</p>
  </div>
</div>
</div>
<div className="col-lg-3 col-md-6 col-sm-12">
<div class="card" style={{width: '18rem',border:'none',marginTop:'25px'}}>
  ...
  <div class="card-body">
    <p class="card-text" style={{fontFamily:'cursive',fontSize:'30px',fontWeight:'bold',marginLeft:'60px'}}>Trousers</p>
  </div>
</div>
</div>
<div className="col-lg-3 col-md-6 col-sm-12">
<div class="card" style={{width: '18rem',border:'none',marginTop:'25px'}}>
  ...
  <div class="card-body">
    <p class="card-text" style={{fontFamily:'cursive',fontSize:'30px',fontWeight:'bold',marginLeft:'60px'}}>Sweaters</p>
  </div>
</div>
</div>
<div className="col-lg-3 col-md-6 col-sm-12">
<div class="card" style={{width: '18rem',border:'none',marginTop:'25px'}}>
  ...
  <div class="card-body">
    <p class="card-text" style={{fontFamily:'cursive',fontSize:'30px',fontWeight:'bold',marginLeft:'60px'}}>Watches</p>
  </div>
</div>
</div>
</div>
