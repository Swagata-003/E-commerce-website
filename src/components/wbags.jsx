...
<div className="container">
  ...
  <div class="card-body">
    <h5 class="card-title">AneeKaant</h5>
    <p class="card-text">Structured Bowling Sling Bag</p>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Yellow Coloured Sling Bag</p>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Structured Sling Bag</p>
  ...
  <div class="card-body">
    <h5 class="card-title">CORSICA PU</h5>
    <p class="card-text">Structured Sling Bag</p>
  ...
  <div class="card-body">
    <h5 class="card-title">ROSS BROWN</h5>
    <p class="card-text">Solid Black Colour Sling Bag</p>
  ...
  <div class="card-body">
    <h5 class="card-title">CORSICA PU</h5>
    <p class="card-text">Women Structured Brown Sling Bag</p>
  ...
  <div class="card-body">
    <h5 class="card-title">Dive & Dale</h5>
    <p class="card-text">Women Bowling Sling Bag </p>
