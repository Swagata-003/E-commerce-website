...
<div className="container">
  <div className="row">
  {filteredData.some(item => item.name === "levis") && (
  ...
  {filteredData.some(item => item.name === "Off Duty") && (
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  ...
  {filteredData.some(item => item.name === "DENIMLOOK") && (
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  ...
  {filteredData.some(item => item.name === "The Indian Garage") && (
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  ...
  {filteredData.some(item => item.name === "Jack & Jones") && (
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
