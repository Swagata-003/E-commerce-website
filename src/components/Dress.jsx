...
<div className="container">
  ...
  <img src="/images/m40.webp" class="card-img-top" alt="..." />
  <div class="card-body">
    <h5 class="card-title">DressBerry</h5>
    <p class="card-text">Women Print Crepe A line Midi Dress</p>
    ...
    <button class="btn btn-primary"style={{marginBottom:'10px'}} onClick={()=>{navigate("/payment")}}>Add To Cart</button>
  </div>
</div>
  </div>
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  <img src="/images/m41.webp" class="card-img-top" alt="..." />
  <div class="card-body">
    <h5 class="card-title">ELYRAA</h5>
    <p class="card-text">Puff Sleeve Cotton Corset Midi Dress</p>
    ...
    <button href="#!" class="btn btn-primary"style={{marginBottom:'10px'}} onClick={()=>{navigate("/payment")}}>Add To Cart</button>
  </div>
</div>
  </div>
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  <img src="/images/m42.webp" class="card-img-top" alt="..." />
  <div class="card-body">
    <h5 class="card-title">Sugathari</h5>
    <p class="card-text">Solid Puff Sleeve A-Line Midi Dress</p>
  ...
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  <img src="/images/m43.webp" class="card-img-top" alt="..."/>
  <div class="card-body">
    <h5 class="card-title">Savana</h5>
    <p class="card-text">Red darted A-Line Dress</p>
  ...
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  <img src="/images/m44.webp" class="card-img-top" alt="..." />
  <div class="card-body">
    <h5 class="card-title">ZWERLON</h5>
    <p class="card-text">Women Abstract Printed Flared Sleeve Fit</p>
  ...
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  <img src="/images/m45.webp" class="card-img-top" alt="..." />
  <div class="card-body">
    <h5 class="card-title">aayu</h5>
    <p class="card-text">Women Abstract Printed Puff Sleeve Fit and Flare Dress </p>
  ...
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  <img src="/images/m46.webp" class="card-img-top" alt="..." />
  <div class="card-body">
    <h5 class="card-title">Berrylush</h5>
    <p class="card-text">Women Layered Dress</p>
  ...
  <div className="col-lg-3 col-md-6 col-sm-12">
    <div class="card" style={{width: '18rem',marginTop:'15px',height:'530px'}}>
  <img src="/images/m47.webp" class="card-img-top" alt="..." />
  <div class="card-body">
    <h5 class="card-title">The Roadster</h5>
    <p class="card-text">Lifestyle Co-Self Design Flared Maxi Dress</p>
